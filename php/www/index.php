<?php
try {
echo "<h1>Janista Sihirunwong</h1>";
echo "<h1>645162010030</h1>";
echo "<h2>lab4</h2>";

$mysql_hostname = "192.168.64.2";
$mysql_user = "root";
$mysql_password = "dbpassw0rd";
$mysql_database = "lab4";
$mysql_port = 3306;
$bd = mysqli_connect($mysql_hostname, $mysql_user, $mysql_password,$mysql_database, $mysql_port) or die("Could not connect database");
if (!$bd) {
